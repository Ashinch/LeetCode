...
public class Compiler {
	public static String run(String language, String code) {
		try {
	        ...
	        String data = "{\"lang\":\"cpp\",\"typed_code\":\"#include <iostream>\\n\\nint main() {\\n    std::cout << \\\"Hello World!\\\\n\\\";\\n}\",\"data_input\":\"\"}";
		...
		try {
        	...
        	case 200:
                ...
                if (((String)json.get("state")).equals("SUCCESS")) {
					if (((String)json.get("run_success")).equals("true")) {
						return "true$$" + (String)json.get("code_output");
					}else {
						return "false$$" + (String)json.get("compile_error");
					}
